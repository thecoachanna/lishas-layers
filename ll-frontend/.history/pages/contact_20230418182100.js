    ...
    return (
      ...
      <>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{3}"required />
          ...
          <input type="file" id="design1" name="design1"></input>
          
          <label for="design2">Select a file:</label>
          <input type="file" id="design2" name="design2"></input>
