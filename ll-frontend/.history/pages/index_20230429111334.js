        ...
        <div className="hero min-h-screen bg-base-200">
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div>
              ...
              <p className="py-6 text-2xl">
                I am a current student in <className=""></>Oakland Community College Culinary Arts program and have been gaining industry experience over the past year working in the bakeries of:</p>
