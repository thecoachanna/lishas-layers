      ...
      <form class="w-full max-w-lg">
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
          ...
          <div class="w-full px-3">
            ...
            ></label>
            <textarea
              className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text"
              id="grid-password"
              type="password"
              placeholder="*Additional Comments*"
            ></textarea>
