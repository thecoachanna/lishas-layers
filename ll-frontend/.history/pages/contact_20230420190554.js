export default function ContactForm() {
  ...
  return (
    ...
    <div>
      ...
      <h3 className="text-gray-600 text-xl italic mb-3 content-center">
      Looking to order a custom cake? Please complete this form and I will
        reach out to you within 1-2 business days.
        </h3>

      <form onSubmit={handleSubmit} class="w-full max-w-lg content-center">
        <div className="flex flex-wrap -mx-3 mb-6 content-center">
